...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_metrics') THEN
    ...
    DROP TRIGGER IF EXISTS update_analytics_metrics_updated_at_v6 ON analytics_metrics;
    DROP TRIGGER IF EXISTS update_analytics_metrics_updated_at_v7 ON analytics_metrics;
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_dashboards') THEN
    ...
    DROP TRIGGER IF EXISTS update_analytics_dashboards_updated_at_v6 ON analytics_dashboards;
    DROP TRIGGER IF EXISTS update_analytics_dashboards_updated_at_v7 ON analytics_dashboards;
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_reports') THEN
    ...
    DROP TRIGGER IF EXISTS update_analytics_reports_updated_at_v6 ON analytics_reports;
    DROP TRIGGER IF EXISTS update_analytics_reports_updated_at_v7 ON analytics_reports;
  END IF;
END $$;
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_metrics') THEN
    CREATE TRIGGER update_analytics_metrics_updated_at_v8
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_dashboards') THEN
    CREATE TRIGGER update_analytics_dashboards_updated_at_v8
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'analytics_reports') THEN
    CREATE TRIGGER update_analytics_reports_updated_at_v8
