/*
  ...
  1. New Tables
    - `breeding_records`
      - Tracks breeding activities and reproductive events
      - Supports different types of records (insemination, pregnancy check, birth)
      - Links to animals table
    
    - `breeding_cycles`
      - Tracks complete breeding cycles
      - Monitors reproductive status and outcomes
